...
This repository is a copy of the official gokrb5 repo with a few things removed.
It does not closely follow the official repo and is only stored here as a dependency for the go-smb library.
